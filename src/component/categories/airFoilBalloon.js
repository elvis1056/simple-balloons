...
import airfoilballoon from '../../picture/airfoilballoon';
import CategoriesLinks from './categoriesLinks';

class AirFoilBalloon extends Component {
        ...
        <div className="wrapper margin-top-20">
          ...
          <div className="categories col-10">
            <div className="categories-row">
              {airfoilballoon.map(({id, src, title, description,NTdollar}) =>
