...
import decoratesingle from '../../picture/decoratesingle';
import CategoriesLinks from './categoriesLinks';

class DecorateSingle extends Component {
        ...
        <div className="wrapper margin-top-20">
          ...
          <div className="categories col-10">
            <div className="categories-row">
              {decoratesingle.map(({id, src, title, description,NTdollar}) =>
